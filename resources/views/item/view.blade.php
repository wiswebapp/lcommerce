    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-5 ftco-animate">
                <a href="storage/product/{{$data['product']->product_image}}" class="image-popup"><img src="storage/product/{{$data['product']->product_image}}" class="img-fluid"
                        alt="{{$data['product']->product_name}}"></a>
            </div>
            <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                ...
                <p class="price"><span>{{formatNum($data['product']->price)}}</span></p>
